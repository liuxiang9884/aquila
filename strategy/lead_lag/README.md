...
实盘长时间运行和测试计划见 `doc/lead_lag_live_runtime_plan.md`。该计划按 signal-only live runner、长时间观察、生产订单闭环、runner execute 禁用边界、REST reconcile / feedback 恢复、小额真实订单 smoke 和端到端 benchmark 的顺序推进。
