...
void PrintStats(const gate::OrderFeedbackSessionStats& session_stats,
                ...
                const aquila::OrderFeedbackShmPublisher& publisher) {
  fmt::print(
...
int RunLive(gate::OrderFeedbackSessionConfig config,
  ...
  aquila::OrderFeedbackShmPublisher publisher(manager.channel());
  using Session =
      gate::OrderFeedbackSession<aquila::OrderFeedbackShmPublisher,
                                 WebSocketPolicy,
...
int Run(const CliOptions& options) {
  ...
  gate::OrderFeedbackSessionConfigResult config_result =
      gate::LoadOrderFeedbackSessionConfigFile(options.config_path);
  if (!config_result.ok) {
