...
POSITION_DETAIL_FIELDS = [
    ...
    "entry_lead_exchange_ns",
    "entry_lead_local_ns",
    "entry_lead_freshness_ns",
    "entry_lag_exchange_ns",
    "entry_lag_local_ns",
    "entry_lag_freshness_ns",
    "exit_lead_exchange_ns",
    "exit_lead_local_ns",
    "exit_lead_freshness_ns",
    "exit_lag_exchange_ns",
    "exit_lag_local_ns",
    "exit_lag_freshness_ns",
    "entry_ns",
    "exit_ns",
    "holding_ns",
    "entry_side",
...
def build_closed_position_row(
    ...
    row = {
        ...
        "entry_lead_exchange_ns": entry.get("lead_exchange_ns", ""),
        "entry_lead_local_ns": entry.get("lead_local_ns", ""),
        "entry_lead_freshness_ns": entry.get("lead_freshness_ns", ""),
        "entry_lag_exchange_ns": entry.get("lag_exchange_ns", ""),
        "entry_lag_local_ns": entry.get("lag_local_ns", ""),
        "entry_lag_freshness_ns": entry.get("lag_freshness_ns", ""),
        "exit_lead_exchange_ns": exit_order.get("lead_exchange_ns", ""),
        "exit_lead_local_ns": exit_order.get("lead_local_ns", ""),
        "exit_lead_freshness_ns": exit_order.get("lead_freshness_ns", ""),
        "exit_lag_exchange_ns": exit_order.get("lag_exchange_ns", ""),
        "exit_lag_local_ns": exit_order.get("lag_local_ns", ""),
        "exit_lag_freshness_ns": exit_order.get("lag_freshness_ns", ""),
        "entry_ns": entry_ns,
        "exit_ns": exit_ns,
