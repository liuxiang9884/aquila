...
class AnalyzeOrderDetailTest(unittest.TestCase):
    def test_parses_submitted_order_and_calculates_fill_quality(self):
        ...
        self.assertEqual(row["ack_exchange_x_in_ns"], "1779676175107000000")
        self.assertEqual(row["ack_exchange_x_out_ns"], "1779676175107083000")
        self.assertEqual(row["ack_exchange_x_in_to_x_out_ns"], "83000")
