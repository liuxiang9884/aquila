...
TEST(CoreMarketDataTypesTest, BookTickerCarriesExchangeAndTopOfBook) {
  ...
  static_assert(sizeof(aquila::BookTicker) == 72);
  ...
  static_assert(offsetof(aquila::BookTicker, event_ns) == 24);
  static_assert(offsetof(aquila::BookTicker, local_ns) == 32);
  static_assert(offsetof(aquila::BookTicker, bid_price) == 40);
  static_assert(offsetof(aquila::BookTicker, bid_volume) == 48);
  static_assert(offsetof(aquila::BookTicker, ask_price) == 56);
  static_assert(offsetof(aquila::BookTicker, ask_volume) == 64);
  ...
  const aquila::BookTicker book_ticker{
      ...
      .event_ns = 1'770'000'000'000'890'000,
  ...
  EXPECT_EQ(book_ticker.event_ns, 1'770'000'000'000'890'000);
...
TEST(CoreMarketDataTypesTest, TradeCarriesGatePublicTradeEvent) {
  ...
  static_assert(offsetof(aquila::Trade, event_ns) == 24);
  ...
  const aquila::Trade trade{
      ...
      .event_ns = 1'770'000'000'000'990'000,
      .local_ns = 1'770'000'000'001'200'000,
      .price = 65'012.5,
      .volume = 17.5,
      .batch_index = 1,
  ...
  EXPECT_EQ(trade.event_ns, 1'770'000'000'000'990'000);
