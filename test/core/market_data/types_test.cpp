...
TEST(CoreMarketDataTypesTest, BookTickerCarriesExchangeAndTopOfBook) {
  ...
  static_assert(alignof(aquila::BookTicker) == aquila::kCacheLineBytes);
  static_assert(sizeof(aquila::BookTicker) == aquila::kCacheLineBytes);
  static_assert(offsetof(aquila::BookTicker, bid_price) == 0);
  static_assert(offsetof(aquila::BookTicker, bid_volume) == 8);
  static_assert(offsetof(aquila::BookTicker, ask_price) == 16);
  static_assert(offsetof(aquila::BookTicker, ask_volume) == 24);
  static_assert(offsetof(aquila::BookTicker, id) == 32);
  static_assert(offsetof(aquila::BookTicker, exchange_ns) == 40);
  static_assert(offsetof(aquila::BookTicker, local_ns) == 48);
  static_assert(offsetof(aquila::BookTicker, exchange) == 56);
  static_assert(offsetof(aquila::BookTicker, symbol_id) == 60);
