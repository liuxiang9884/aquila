...
TEST(GateSubmitResponseParserTest, ParsesOrderPlaceAckEcho) {
  ...
  EXPECT_EQ(parsed.exchange_request_ingress_ns, 1681985856667508000LL);
  EXPECT_EQ(parsed.exchange_response_egress_ns, 1681985856667598000LL);
  EXPECT_EQ(parsed.exchange_process_ns, 90000LL);
