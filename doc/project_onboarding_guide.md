...
3. V1 emergency smoke 和外围 guard wrapper 已完成；下一步通过 `scripts/lead_lag/run_live_with_guard.py` 进入小额真实订单 smoke：filled open / close、unfilled-cancel、rejected / cancel-rejected。
