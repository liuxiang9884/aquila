...
| `doc/runtime_config.md` | 修改 `config/runtime.toml` 或新增 session 配置时读 | `instrument_db`、`data_sessions`、WebSocket endpoint / execution_policy / read_path / heartbeat / reconnect 字段和默认值。 |
