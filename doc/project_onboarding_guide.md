...
4. 之后优先做端到端 benchmark 和更长时间真实订单运行 guardrails；account / position realtime feedback 作为 V2 可选能力，不作为当前 V1 前置项。failure response 继续前先确认 Gate 可返回最终 error 的请求形态。
