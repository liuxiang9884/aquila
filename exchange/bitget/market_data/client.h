#ifndef AQUILA_EXCHANGE_BITGET_MARKET_DATA_CLIENT_H_
#define AQUILA_EXCHANGE_BITGET_MARKET_DATA_CLIENT_H_
 ...
 public:
  ...
  websocket::DeliveryResult OnBinaryPayload(
    ...
    switch (dispatch.message_type) {
      case BitgetSbeMessageType::kBookTicker:
      ...
      case BitgetSbeMessageType::kPublicTrade:
...
#endif  // AQUILA_EXCHANGE_BITGET_MARKET_DATA_CLIENT_H_
