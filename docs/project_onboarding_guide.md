...
| Core base structures | `core/base/fixed_ordered_slot_pool.h`、`test/core/base/base_structures_test.cpp`、`benchmark/strategy/lead_lag_group_container_benchmark.cpp` |
