...
| Core base structures | `core/base/fixed_active_slots.h`、`test/core/base/base_structures_test.cpp`、`benchmark/strategy/lead_lag_group_container_benchmark.cpp` |
...
FixedActiveSlots / group-container focused checks:
