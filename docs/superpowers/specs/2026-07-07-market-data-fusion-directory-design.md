...
- `book_ticker_fusion.h` / `trade_fusion.h` 包含 feed-specific core facade；`*_runner.h` 包含 feed-specific runner
  traits / alias。
- `fastest_route_fusion*.h`、`fusion_metadata_writer.h`、`fusion_metadata_policy.h` 是公共实现文件，不适合塞进
  feed facade。
...
- 只合并纯 alias / 轻量 traits；公共算法、runner loop、thread wrapper 和 writer 仍保持独立文件。
...
core/market_data/fusion/
  ...
  config.h
  fastest_route.h
  fastest_route_runner.h
  fastest_route_thread.h
  metadata.h
  metadata_policy.h
  metadata_writer.h
  thread.h
